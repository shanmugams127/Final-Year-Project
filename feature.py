...
## Field List
        ...
        self.field.append("having_IPhaving_IP_Address")
        self.field.append("URLURL_Length")
        self.field.append("Shortining_Service")
        self.field.append("having_At_Symbol")
        self.field.append("double_slash_redirecting")
        self.field.append("Prefix_Suffix")
        self.field.append("having_Sub_Domain")
        self.field.append("SSLfinal_State")
        self.field.append("Domain_registeration_length")
        self.field.append("Favicon")
        

        self.field.append("port")
        self.field.append("HTTPS_token")
        self.field.append("Request_URL")
        self.field.append("URL_of_Anchor")
        self.field.append("Links_in_tags")
        self.field.append("SFH")
        self.field.append("Submitting_to_email")
        self.field.append("Abnormal_URL")
        self.field.append("Redirect")
        self.field.append("on_mouseover")

        self.field.append("RightClick")
        self.field.append("popUpWidnow")
        self.field.append("Iframe")
        self.field.append("age_of_domain")
        self.field.append("DNSRecord")
        self.field.append("web_traffic")
        self.field.append("Page_Rank")
        self.field.append("Google_Index")
        self.field.append("Links_pointing_to_page")
        self.field.append("Statistical_report")
